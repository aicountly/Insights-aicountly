...
| --- | --- | --- |
| `web/dist/` | `<remote root>/` | https://insights.aicountly.com |
| `server-php/` | `<remote root>/api/` | https://insights.aicountly.com/api |
...
`https://insights.aicountly.com/api/.env` unless Apache is told otherwise. `server-php`
