...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Insights').trim() || 'Insights'
 ...
 * with the app on both insights.aicountly.com and insights.gh.aicountly.com. That
