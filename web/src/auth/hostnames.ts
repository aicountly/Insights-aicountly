 ...
 * insights.aicountly.com and insights.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'insights').trim() || 'insights'
...
/**
 * `insights.aicountly.com` and `insights.gh.aicountly.com` both resolve to
 * `insights`, which is what the portal expects in authentication_jump.
 */
