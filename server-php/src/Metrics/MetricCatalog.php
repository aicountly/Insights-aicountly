    ...
    private static function definitions(): array
    {
        ...
        return [
            ...
            new MetricDefinition(
                ...
                label: 'Collections',
                definition: 'Money received from customers in the period, measured as the customer-side credit on posted receipt vouchers. Discount allowed and TDS lines on the same voucher are excluded because they reduce the balance without money arriving. Receipts with no party cannot be attributed and are reported separately.',
                owningProduct: 'books',
            ...
            new MetricDefinition(
                ...
                label: 'Payments made',
                definition: 'Money paid to suppliers in the period, measured as the supplier-side debit on posted payment vouchers.',
                owningProduct: 'books',
