 ...
 * an Insights report needs — positioned text, rules, filled rectangles — is
 ...
 * therefore any script Helvetica cannot write. A Devanagari customer name will
...
final class PdfDocument
{
    ...
    public function render(string $title = 'Aicountly Insights'): string
    {
        $pages = $this->pages;
        ...
        $out .= sprintf(
            "trailer\n<< /Size %d /Root 1 0 R /Info << /Title (%s) /Producer (Aicountly Insights) >> >>\nstartxref\n%d\n%%%%EOF\n",
            $count,
