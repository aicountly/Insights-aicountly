 ...
 * pools is blocked on the other and the queue answers 504.
 *
 * This matters more in Insights than anywhere else: an overview screen fans out
 * to five products at once, and a product that reaches back would multiply that
 * by its own fan-out.
 *
 * See books-react-app/docs/CROSS_SERVICE_CALL_RULES.md — the fleet-wide
...
final class CrossServiceCallContext
{
    ...
    private const KNOWN = [
        'books', 'inventory', 'manage', 'contacts', 'pos', 'sales',
        'purchases', 'billing', 'crm', 'hrms', 'pay', 'insights',
    ];
